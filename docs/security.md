...
plugin declared — and, for the same reason, a plugin's browser call made from a
queue or a worker it built itself rather than from the command it was asked to
run.
