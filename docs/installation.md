...
a `.dmg` — `0.1.1-alpha.5` at the time of writing. Alphas are published as
...
asks once at launch if you said yes to its skills but were never asked about
the command. It puts a `patcher`
