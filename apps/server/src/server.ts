...
import { registerHostDaemonKeyRoutes } from "./routes/host-daemon-keys.js";
...
export function createApp(
  ...
  registerHostDaemonKeyRoutes(publicApi, deps);
  ...
  registerPluginCatalogRoutes(publicApi, pluginCatalogService, deps);
