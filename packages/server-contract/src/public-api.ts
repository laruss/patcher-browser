...
export const publicApiRoutes = {
  ...
  system: {
    ...
    cliCommandStatus: defineRoute({
      path: "/system/cli-command",
      method: "get",
      request: optionalQueryRequest<EmptyInput, SystemCliCommandStatusQuery>(
        systemCliCommandStatusQuerySchema,
      ),
      response: jsonResponse<SystemCliCommandStatusResponse>(),
    }),
    installCliCommand: defineRoute({
      path: "/system/cli-command/install",
      method: "post",
      request: jsonRequest<EmptyInput, SystemInstallCliCommandRequest>(
        systemInstallCliCommandRequestSchema,
      ),
    ...
    browserAccessGrants: defineRoute({
      path: "/browser/access-grants",
      method: "get",
      request: noRequest(),
      response: jsonResponse<SystemBrowserAccessGrantListResponse>(),
    }),
    createBrowserAccessGrant: defineRoute({
      path: "/browser/access-grants",
      method: "post",
      request: jsonRequest<EmptyInput, SystemBrowserAccessGrantCreateRequest>(
        systemBrowserAccessGrantCreateRequestSchema,
      ),
    ...
    cliSkillsSetup: defineRoute({
      ...
      method: "post",
      request: jsonRequest<EmptyInput, SystemCliSkillsSetupRequest>(
        systemCliSkillsSetupRequestSchema,
      ),
      response: jsonResponse<SystemCliSkillsSetupResponse>(),
    }),
