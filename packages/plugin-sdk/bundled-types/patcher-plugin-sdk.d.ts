...
declare const appSettingsSchema: z$1.ZodObject<
  {
    ...
    providerEgressAllowedHosts: z$1.ZodPipe<
...
declare const browserExternalAccessLevelSchema: z$1.ZodEnum<{
  full: "full";
  off: "off";
  read: "read";
  browse: "browse";
...
type BrowserExternalAccessLevel = z$1.infer<
...
declare const consentPendingInteractionSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type ConsentPendingInteraction = z$1.infer<
...
declare const hostDaemonCommandRegistry: {
          ...
          z$1.ZodObject<
            {
              ...
              providerEgressAllowedHosts: z$1.ZodOptional<
                z$1.ZodArray<z$1.ZodString>
              >;
            },
            z$1.core.$strip
  ...
  "host.global_skills_status": HostDaemonCommandDescriptor<
    ...
    true
  >;
  "host.cli_command_status": HostDaemonCommandDescriptor<
    ...
    true
  >;
  "host.install_cli_command": HostDaemonCommandDescriptor<
...
declare const systemConfigResponseSchema: z$1.ZodObject<
  {
    ...
    cliSkillsUpdates: z$1.ZodDefault<
      z$1.ZodArray<
        z$1.ZodObject<
          {
            hostId: z$1.ZodString;
...
declare const systemCliCommandStatusResponseSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemCliCommandStatusResponse = z$1.infer<
...
declare const systemInstallCliCommandRequestSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemInstallCliCommandRequest = z$1.infer<
...
declare const systemInstallCliCommandResponseSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemInstallCliCommandResponse = z$1.infer<
...
declare const systemBrowserExternalAccessRequestSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemBrowserExternalAccessRequest = z$1.infer<
...
declare const systemBrowserExternalAccessResponseSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemBrowserExternalAccessResponse = z$1.infer<
...
declare const systemBrowserAccessGrantCreateRequestSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemBrowserAccessGrantCreateRequest = z$1.infer<
...
declare const systemBrowserAccessGrantCreateResponseSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemBrowserAccessGrantCreateResponse = z$1.infer<
...
declare const systemBrowserAccessGrantListResponseSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemBrowserAccessGrantListResponse = z$1.infer<
...
declare const systemBrowserAccessRequestCreateRequestSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemBrowserAccessRequestCreateRequest = z$1.infer<
...
declare const systemBrowserAccessRequestCreateResponseSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemBrowserAccessRequestCreateResponse = z$1.infer<
 ...
 * the one asked for.
 */
declare const systemBrowserAccessRequestOutcomeResponseSchema: z$1.ZodDiscriminatedUnion<
  [
    z$1.ZodObject<
      {
  ...
  "outcome"
>;
type SystemBrowserAccessRequestOutcomeResponse = z$1.infer<
...
declare const systemBrowserAccessRequestDecideRequestSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemBrowserAccessRequestDecideRequest = z$1.infer<
...
declare const systemBrowserAccessRequestListResponseSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemBrowserAccessRequestListResponse = z$1.infer<
...
declare const systemCliSkillsOfferRequestSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemCliSkillsOfferRequest = z$1.infer<
...
declare const systemCliSkillsOfferResponseSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemCliSkillsOfferResponse = z$1.infer<
...
declare const systemCliSkillsSetupRequestSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemCliSkillsSetupRequest = z$1.infer<
...
declare const systemCliSkillsSetupResponseSchema: z$1.ZodObject<
  ...
  z$1.core.$strip
>;
type SystemCliSkillsSetupResponse = z$1.infer<
...
>;
type PatcherRealtimeConnectionState =
  | "connecting"
  | "connected"
  | "disconnected";
...
type PatcherRealtimeCallback<TEventName extends PatcherRealtimeEventName> = (
...
type PatcherRealtimeSubscribeArgsUnion =
...
type PatcherRealtimeSubscribeArgs<
...
type SystemCreateBrowserAccessGrantResult =
...
type SystemRequestBrowserAccessResult =
  SystemBrowserAccessRequestCreateResponse;
type SystemBrowserAccessRequestOutcomeResult =
  SystemBrowserAccessRequestOutcomeResponse;
type SystemDecideBrowserAccessRequestArgs =
 ...
 */
type PluginBrowserDownloadState =
  | "completed"
  | "cancelled"
  | "interrupted"
  | "refused";
...
type PluginBrowserDownloadHandler = (
 ...
 */
type PluginBrowserAuthProvider = (
 ...
 */
type PluginBrowserPdfTextProvider = (
 ...
 */
type PluginBrowserExternalLinkHandler = (
 ...
 * history.
 */
type PluginBrowserHistoryFilter = (
...
interface PluginBrowserPage {
   ...
   *
   * **A capture needs the tab on screen.** A picture is what the browser draws,
   * and it draws nothing for a tab in the background, or for any tab while the
   * user is on another Patcher screen. That is `page_read_failed` — always for
   * `fullPage`, and for the viewport unless the window is minimised, which is
   * nothing to build on — while the tab's text, snapshot and logs still answer.
   */
  screenshot(
    args?: {
      tabId?: string;
