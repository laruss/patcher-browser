...
- Inline and external CSS/JavaScript are supported. Remote images, fonts,
  ...
  opaque-origin iframe and cannot access the Patcher page, cookies, or storage.
...
The Patcher app replaces the directive with a sandboxed preview. If the plugin is
